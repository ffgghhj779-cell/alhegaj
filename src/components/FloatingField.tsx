...
const fieldShell =
  "peer min-h-11 w-full rounded-md border border-border bg-[var(--surface-elevated)] px-4 pt-6 pb-2.5 text-[0.9375rem] text-foreground outline-none transition-[border-color,box-shadow,background-color] duration-300 placeholder-transparent focus:border-gold focus:shadow-[0_0_0_3px_rgba(183,163,90,0.22)] [&>option]:bg-[var(--surface-elevated)] [&>option]:text-foreground";
