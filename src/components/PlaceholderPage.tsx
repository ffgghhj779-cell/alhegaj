...
export function PlaceholderPage({ title, description }: PlaceholderPageProps) {
  return (
    <section className="mx-auto flex min-h-[60vh] max-w-7xl flex-col items-center justify-center px-4 py-20 text-center sm:px-6 lg:px-8">
      ...
      <Link
        href="/"
        className="mt-8 inline-flex rounded-sm border border-border px-5 py-2.5 text-sm font-medium text-black transition-colors duration-300 hover:border-gold hover:text-gold"
      >
        العودة للرئيسية
      </Link>
    </section>
