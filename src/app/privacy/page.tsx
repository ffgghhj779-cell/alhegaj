          ...
          <div className="surface-card mt-10 space-y-8 p-6 sm:p-9">
            <section>
              ...
              <p className="body-copy mt-3">
                عند إرسال نموذج التواصل أو طلب خدمة قد تتضمن البيانات: الاسم، رقم
                الجوال، نوع الاهتمام أو تفاصيل الخدمة، ونص الرسالة. لا نطلب بيانات
                بطاقات ائتمان عبر الموقع.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="body-copy mt-3">
                تُحفظ الطلبات داخل منصة الحجاز وتُعرض على لوحة الإدارة للرد وتقديم
                الاستشارة العقارية. لا يُحوَّل نموذج الموقع تلقائياً إلى واتساب.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="body-copy mt-3">
                لا نبيع بياناتكم. إذا اخترتم التواصل عبر زر واتساب المباشر، فقد
                تمر المحادثة عبر تطبيق واتساب (ميتا) وفق سياساتهم.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="body-copy mt-3">
                تُحفظ طلبات الموقع في قاعدة بيانات المنصة لمتابعة الحالة. لأي طلب
                حذف أو استفسار حول الخصوصية، راسلونا على البريد أدناه.
              </p>
            </section>
